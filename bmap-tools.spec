...
Source0  : https://github.com/yoctoproject/bmaptool/archive/refs/tags/v3.9.0.tar.gz
...
%prep
%setup -q -n bmaptool-3.9.0
cd %{_builddir}/bmaptool-3.9.0
pushd ..
cp -a bmaptool-3.9.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1745955727
...
cp %{_builddir}/bmaptool-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/bmap-tools/4cc77b90af91e615a64ae04893fdffa7939db84c || :
